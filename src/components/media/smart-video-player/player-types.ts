...
export type SmartVideoPlayerProps={asset:ContentAsset;creator:CreatorMetadata;context:string;resumePlayback?:boolean;onProgress?:(seconds:number)=>void;onEnded?:()=>void};
