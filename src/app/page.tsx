...
export default async function Landing(){
  ...
  return <AppShell tenant={tenant} user={{email:"maria@demo.local",name:"María"}} demo>
    <div className="today-dashboard">
      ...
      <NextStepCard preparation label="Módulo de preparación" title="P.A.U.S.A." description="Antes de escribirle, vuelve a ti. Date diez minutos para escuchar lo que sientes antes de decidir." href="/demo/sos" action="Comenzar con una P.A.U.S.A."/>
